    ...
    >
      ...
      <div className="relative z-10 mx-auto grid min-h-screen max-w-7xl items-center gap-10 px-6 pb-16 pt-32 md:grid-cols-2 md:px-10 lg:px-16">
        ...
        <div className="max-w-2xl">
          ...
          <h1
            ref={titleRef}
            className="overflow-hidden text-5xl font-black leading-[0.95] tracking-tight text-[#171717] sm:text-6xl md:text-7xl lg:text-[88px]"
          >
          ...
          <div className="hero-buttons mt-8 flex flex-wrap items-center gap-4">
            ...
            <motion.a
              ...
              className="flex items-center gap-2 px-4 py-3.5 text-sm font-bold text-[#171717]"
            >
              Discover Kothari
        ...
        <div className="relative flex items-center justify-center">
          ...
          >
            {/* img */}
            {/* Product Showcase */}
            <div className="relative w-full max-w-2xl h-[500px] flex items-end justify-center">
              {/* Background Circle */}
              <div className="absolute w-[430px] h-[430px] rounded-full bg-red-600" />
      ...
      <div className="absolute bottom-7 left-1/2 z-20 hidden -translate-x-1/2 flex-col items-center gap-2 md:flex">
        ...
        <div className="h-10 w-[1px] overflow-hidden bg-gray-300">
          <motion.div
            animate={{
              y: [0, 40, 0],
            }}
            ...
            className="h-1/2 w-full bg-[#e51b23]"
          />
        </div>
      </div>
    </section>
